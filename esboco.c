...
void quest_1a()
{
  char *str1 = "Após uma hora você sai da taverna e encontra Abdam com sua carroça te esperando para sair."
...
void main()
{
  ...
  charSelection();
  clrscr();
  char *str1 = "Obstinado a conhecer a grande cidade de Solitude e conhecer o mestre de sua arte"
  ...
  char *str2 = "Você abre a porta da taverna e vê o bardo tocando uma musica animadora alguns clientes ao redor bebendo de cantando"
